    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form method="GET" action="{{ route('rh.catraca.bilhetes') }}" class="form-horizontal">
                        <div class="row">
                            <div class="col-md-8">
...
{{--                            <div class="col-md-4">--}}
{{--                                <div class="form-group">--}}
{{--                                    <label for="data_inicio" class="col-sm-4 control-label">Data</label>--}}
{{--                                    <div class="col-sm-8">--}}
{{--                                        <input type="text" name="DataHora" id="DataHora" class="form-control datepicker"--}}
{{--                                               value="{{ request('DataHora') }}" placeholder="dd/mm/aaaa">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="row">--}}
                            <div class="col-md-4 text-right">
                                ...
                                <a href="{{ route('rh.catraca.bilhetes') }}" class="btn btn-default">
